...
int main(int argc, char **argv)
{
    ...
    std::ofstream file_objects("/home/yutong/OA-SLAM/Data/diamond_all/map_objects.json");
    ...
    while (1)
    {
        ...
        cv::Mat m = SLAM.TrackRGBD(imRGB,imD,tframe, detections, true);
